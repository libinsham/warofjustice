/**
 * lucide-react removed all brand/logo icons (Facebook, X, YouTube,
 * Instagram, etc.) in recent major versions — trademarked logos are out
 * of scope for a generic icon library now. These are small hand-written
 * SVGs instead, sized to match lucide's className-driven sizing
 * (h-4 w-4 etc. work the same way via `fill="currentColor"`).
 */
